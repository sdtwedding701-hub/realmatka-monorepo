        ...
        <section id="download" className="section-shell px-4 py-6 sm:px-6 sm:py-8 xl:px-8">
          <div className="mb-5 flex flex-wrap items-center justify-between gap-3">
            <div>
              ...
              <h2 className="mt-2 text-2xl font-extrabold sm:text-3xl">Screenshots</h2>
            </div>
            <a href={apkUrl} className="action-primary" download>Download APK</a>
          </div>

          <div className="grid grid-cols-3 gap-2 sm:gap-4 lg:grid-cols-3 lg:items-stretch">
            ...
            <div className="glass-card overflow-hidden p-2 sm:p-3">
              <div className="relative aspect-[9/18] overflow-hidden rounded-[20px] border border-white/10 bg-[#08111f] sm:rounded-[28px]">
                <Image src="/app-screen-1.jpg" alt="Real Matka app screen 3" fill className="object-cover" />
              </div>
            </div>
          </div>
        </section>
